"""
Webots runtime controller for the policy trained in phase_1_1_initial_training.py
(random initial yaw, same observation/action space as phase 1).
"""
import os
import platform
import sys
...
MODEL_PATH = "following_red_ball_model_phase_1_1"
