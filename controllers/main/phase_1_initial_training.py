...
def run_training(
    ...
    output_path="following_red_ball_model",
    device=None,
):
    """
    Train or continue SAC on this phase's environment.

    resume_path: if set and the file exists, load this checkpoint (.zip optional);
                 otherwise start a new model.
    """
    import torch
